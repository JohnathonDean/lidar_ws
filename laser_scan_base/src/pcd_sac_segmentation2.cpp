/*欧式聚类分团块拟合直线，然后对直线的系数取平均值
    结果显示这种方法的误差比直接拟合直线的误差大*/
...
void pointcloud_callback(const sensor_msgs::PointCloudConstPtr &pointcloud_msg) {
    ...
    ec.setClusterTolerance (0.008);                     // 设置近邻搜索的搜索半径为0.0cm
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "cloud_sac_segmentation2");
  ros::NodeHandle nh;
